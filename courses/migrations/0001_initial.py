# Generated by Django 5.0.14 on 2026-07-15 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ForeignKey(limit_choices_to={'role': 'INSTRUCTOR'}, on_delete=django.db.models.deletion.CASCADE, related_name='conducted_courses', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.PositiveIntegerField(help_text='Urutan posisi materi (dimulai dari angka 1)', validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['role'], name='courses_use_role_f8fc4e_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
